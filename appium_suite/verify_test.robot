...
TC1_ValidCredential
   ...
   Input Text    xpath=//*[contains(@text,'Email') or contains(@text,'gmail')]        pulipriyankareddy@gmail.com
   Click Element    //*[@text='Password']
   Input Text    //*[@text='Password']    AMMAbaba@5
   ...
   Wait Until Page Contains Element    //*[contains(@text,'Short Set')]        
   Click Element   //*[contains(@text,'Short Set')]
   #Click Element    //*[contains(@text,'ADD TO CART')]
   Sleep    5s    
   Click Element    //*[@text='3 months']
   Click Element    //*[@text='ADD TO CART']
   Sleep    5s    
   Wait Until Page Contains Element    //*[@resource-id='com.jcp:id/cart_icon']    
   ...
   Click Element    //*[contains(@text,'Puli')]
   Sleep    2s    
